...
var cards = [
  ...
  new Card(
      ...
      'The first show named Crufts - Crufts Greatest Dog Show — was held at the Royal Agricultural Hall, Islington, in 1891.',
  ...
  new Card(
      ...
      'On the Origin of Species (or, more completely, On the Origin of Species by Means of Natural Selection, or the Preservation of Favoured Races in the Struggle for Life), published 24 November 1859, considered to be the foundation of evolutionary biology.',
 ...
 new Card (
  ...
  new Card(
      ...
      'The London Underground (also known simply as the Underground, or the Tube) serves the London region, England and some parts of the adjacent counties of Buckinghamshire, Essex and Hertfordshire.', 
  ...
  new Card(
      ...
      'The first women to take her seat was Nancy Astor (Viscountess Astor), after a by-election in December 1919. She was elected as a Conservative for the Plymouth Sutton constituency.', 
  ...
  new Card(
      ...
      'It was not until the Equal Franchise Act of 1928 that women over 21 were able to vote; women finally achieved the same voting rights as men. This increased the number of women eligible to vote to 15 million.', 
  ...
  new Card(1895,
      ...
      'The National Trust was founded on 12 January 1895 by Octavia Hill, Sir Robert Hunter and Canon Hardwicke Rawnsley.', 
  ...
  new Card(1997,
      ...
      'Harry Potter is a series of fantasy novels written by British author J. K. Rowling. They chronicle the lives of a young wizard, Harry Potter, and his friends Hermione Granger and Ron Weasley, who are students at Hogwarts School of Witchcraft and Wizardry.', 
  ...
  new Card(1959,
      ...
      'The M1 was Britains first full-length motorway it opened in 1959. It had no speed limits, no central reservation or crash barriers, and no lighting.', 
  ...
  new Card(1264,
      ...
      'Simon de Montfort’s parliament of 1265 is sometimes referred to as the first representative English parliament, because of its inclusion of both the knights and the burgesses, Montfort is often regarded as the founder of the House of Common', 
  ...
  new Card(1215,
      ...
      'Magna Carta Libertatum (Medieval Latin for "Great Charter of Freedoms"), commonly called Magna Carta (also Magna Charta; "Great Charter"), is a charter of rights agreed to by King John of England.',
  ...
  new Card(1799,
      ...
      'Income Tax was the first tax in British history to be levied directly on peoples earnings. It was introduced in 1799 by the then Prime Minister William Pitt the Younger; a temporary measure to cover the cost of the Napoleonic Wars.',
  ...
  new Card(1994,
      ...
      'The Channel Tunnel (French: Le tunnel sous la Manche), also referred to as the Chunnel, is a 50.45-kilometre (31.35 mi) railway tunnel that connects Folkestone (Kent, England) with Coquelles (Pas-de-Calais, France).', 
  ...
  new Card(1983,
      ...
      'The old style £1 coin was introduced in 1983 to replace the Bank of England £1 note, which remained in circulation alongside the coins until 1988.', 
